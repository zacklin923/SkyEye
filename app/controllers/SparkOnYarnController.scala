...
object SparkOnYarnController extends Controller {

  val sparkonyarn_resourcemanager_http_addresss = Play.application.configuration.getString("hadoop.sparkonyarn.resourcemanager.http.address").get
  val serviceRoot = "http://" + sparkonyarn_resourcemanager_http_addresss + "/ws/v1/cluster/"
