...
/**
 * Created by zhugb on 15-8-31.
 */
public class DailyBillController extends Controller {
    ...
    public static Result dailyBill(String project, String date, String orderBy, String order) {
        ...
        JsonNode costs = Json.toJson(ClusterCostController.costOfProject(project, date, tomorrowStr, orderBy, order));
